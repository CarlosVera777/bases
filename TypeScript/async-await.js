...
//   })
// }
var usuario = { id: 4, name: 'D' };
function createUser(user) {
    return __awaiter(this, void 0, void 0, function () {
        var existUserDB, savedUserDB;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Finding...");
                    return [4 /*yield*/, findUser(user.id)];
                case 1:
                    existUserDB = _a.sent();
                    console.log("finish function find - Encontrado? ->", existUserDB);
                    if (!!existUserDB) return [3 /*break*/, 3];
                    console.log("saving...");
